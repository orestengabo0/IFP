  ...
  return (
    <div className={styles.jobChoice}>
      ...
      <form className={`jobChoiceForm ${styles.jobChoiceForm}`}>
        <div className={styles.inputGroup} onClick={() => handleCheckBoxClick('Farmer')}>
        ...
        <div className={styles.inputGroup} onClick={() => handleCheckBoxClick('Sponsor')}>
          <span className={styles.icon}>
            {selectedJob ==='Sponsor' ? (
                <MdRadioButtonChecked size={30} color="green" />
            ) : (
        ...
        <div className={styles.inputGroup} onClick={() => handleCheckBoxClick('Middle Man')}>
          <span className={styles.icon}>
        ...
        <button className={`${styles.submitButton} mt-5 fw-semibold fs-4`}>Continue</button>
    </div>
  );
};
